...
public class TeamRegisterPlayerEvent extends Event implements Cancellable {
    ...
    public TeamRegisterPlayerEvent(Team team, OfflinePlayer p) {
        this.team = team;
        this.p = p;
    }
    ...
    /**It is recommended to set {@link TeamRegisterPlayerEvent#setCancelMessage(Component)} as well.
